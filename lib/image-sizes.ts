...
export const imageSizes: Record<string, [number, number]> = {
  ...
  "/images/daire-camasir.jpg": [2048, 1536],
  "/images/daire-ortak-alan.jpg": [1600, 1200],
  "/images/daire-yemek-masasi.jpg": [2048, 1536],
  "/images/hero-mutfak.jpg": [2048, 1536],
  "/images/hero-oda.jpg": [2048, 1536],
  "/images/iki-kisilik-1.webp": [1268, 953],
  "/images/iki-kisilik-mutfak.jpg": [1600, 1200],
  "/images/iki-kisilik-oda.jpg": [2048, 1536],
  ...
  "/images/tek-kisilik-5.jpg": [2048, 1536],
  "/images/tek-kisilik-6.jpg": [2048, 1536],
  "/images/tek-kisilik-7.jpg": [2048, 1536],
  "/images/tek-kisilik-best-1.jpg": [2048, 1536],
  "/images/tek-kisilik-best-2.jpg": [2076, 1422],
  "/images/tek-kisilik-mutfak.jpg": [2048, 1536],
  "/images/video-kapak.jpg": [1280, 720],
};
